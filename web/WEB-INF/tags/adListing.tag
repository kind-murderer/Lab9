...
<c:if test="${adListing!=null}">
    ...
    <td style="background-color:#bfd660;">
    Тема объявления<br>
    <a href="<c:url value="${pageContext.request.requestURL}">
    <c:param name="sort" value="subject"/>
    <c:param name="dir" value="asc"/>
</c:url>"><img src="<c:url value="/resources/asc1.png"/>" width="20" height="19" border="0" align="absmiddle" alt="pic"></a>
    <%----%>
    <a href="<c:url value="${pageContext.request.requestURL}">
    <c:param name="sort" value="subject"/>
    <c:param name="dir" value="desc"/>
</c:url>"><img src="<c:url value="/resources/desc1.png"/>" width="20" height="19" border="0" align="absmiddle" alt="pic"></a>
    </td>
    ...
    <c:forEach items="${adListing}" var="ad">
        <tr valign="top">
            <td>
                ...
                <a href="<c:url value="/viewAd.jsp"><c:param name="id" value="${ad.id}" /></c:url>">
